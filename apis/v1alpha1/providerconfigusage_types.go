...
var (
	...
	ProviderConfigUsageGroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ProviderConfigUsageKind}.String()
	...
	ProviderConfigUsageListGroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ProviderConfigUsageListKind}.String()
