...
type ClientParameters struct {
	...
	Credentials              ClientParametersCredentials `json:"credentials,omitempty"`
...
// ClientCredentials are the configurable fields of a Client's credentials.
type ClientCredentials struct {
	FederatedIdentities []ClientCredentialsFederatedIdentity `json:"federatedIdentities,omitempty"`
}

// ClientCredentialsFederatedIdentity are the configurable fields of a Client's federated identity credentials.
type ClientCredentialsFederatedIdentity struct {
