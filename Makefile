# ====================================================================================
# Setup Project
PROJECT_NAME := provider-pocketid
...
XPKGS = provider-pocketid
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-pocketid: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider PocketId CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider PocketId controllers
...
# This target prepares repo for your provider by replacing all "pocketid"
